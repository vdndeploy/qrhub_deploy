...
import { Bell, MousePointerClick, Send, Megaphone, Sparkles, Loader2, Users, Smartphone, BellOff } from 'lucide-react';
...
const PushAnalytics = () => {
  ...
  // Installs KPI section — backend fills this when the pwa_devices
      ...
      <div className="rounded-2xl border border-gray-200 dark:border-white/10 bg-gray-50/60 dark:bg-white/[0.02] p-3 sm:p-4" data-testid="push-analytics-installs">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
          ...
          <div className="rounded-xl bg-white dark:bg-white/[0.02] border border-gray-200 dark:border-white/10 px-3 py-2.5">
            <p className="text-[10px] uppercase tracking-widest font-semibold text-gray-500 dark:text-[#6a6a72] flex items-center gap-1">
              <span className="inline-block w-2 h-2 rounded-full bg-gray-800 dark:bg-white" />
              iOS
            </p>
            <p className="text-2xl font-black tracking-tight text-gray-900 dark:text-white tabular-nums">
              {installs.by_os?.ios || 0}
            </p>
          </div>
          <div className="rounded-xl bg-white dark:bg-white/[0.02] border border-gray-200 dark:border-white/10 px-3 py-2.5">
            <p className="text-[10px] uppercase tracking-widest font-semibold text-gray-500 dark:text-[#6a6a72] flex items-center gap-1">
