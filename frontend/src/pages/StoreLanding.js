  ...
  return (
    ...
    >
      ...
      <main className="mx-auto w-full max-w-md min-h-dvh bg-white shadow-[0_0_80px_-20px_rgba(0,0,0,0.08)] flex flex-col">
        ...
        {/* Socials — premium brand-accurate buttons via reusable component. */}
          ...
          <div className="px-6 mt-7 flex items-center justify-center gap-3">
            {store.instagram && (
              <BrandSocialIcon
                ...
                testId="store-landing-instagram-btn"
              />
            )}
            {store.facebook && (
              <BrandSocialIcon
                ...
                href={store.facebook}
                onClick={() => track('store_landing_social_click')}
                testId="store-landing-facebook-btn"
              />
            )}
            {store.tiktok && (
              <BrandSocialIcon
                ...
                href={store.tiktok}
                onClick={() => track('store_landing_social_click')}
                testId="store-landing-tiktok-btn"
              />
            )}
          </div>
        )}
